...
\centering
\includegraphics[width=\linewidth]{tikz_plots/DoRDecodingOverview_n2-1.png}
\caption{Image 1 test}
\label{fig:image1}
\end{minipage}%
\hfill
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[width=\linewidth]{tikz_plots/DoRDecodingOverview_n4-1.png}
\caption{Image 2 test}
\label{fig:image2}
\end{minipage}
\end{figure}
...
\label{fig:DoRExampleDecoding_n2}
\end{figure}
...
\label{fig:DoRexampleDecoding_n4}
\end{figure}
