...
\DeclareAcronym{DoR}{short='DoR',long='Decode or Reject'}
...
\begin{theorem}
	\ac{AWGN}Every finite subgroup of the multiplicative group of a field is cyclic.
\end{theorem}
